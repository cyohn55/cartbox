 ...
 *
 * Composited over the cart's frame by the player.
 *
 * Authentication, ownership, body validation and the write itself all live in
 * the shared sidecar handler, driven by the registry entry for "particles"
...
export function PUT(
  ...
  return handleSidecarPut(request, params.cartId, "particles");
}
