...
export const PROP_SPECS: readonly PropSpec[] = [
  { sprite: ARCADE, depth: 10, fx: 0.11, fy: 0.44, cell: 2, motion: motion({ bobPhase: 0.0, spinPhase: 0.05 }) },
  { sprite: CONSOLE, depth: 8, fx: 0.82, fy: 0.8, cell: 2, motion: motion({ bobPhase: 0.5, spinPhase: 0.55 }) },
  { sprite: GAMEPAD, depth: 5, fx: 0.47, fy: 0.84, cell: 2, motion: motion({ bobPhase: 0.25, spinPhase: 0.3 }) },
  { sprite: CARTRIDGE, depth: 6, fx: 0.31, fy: 0.17, cell: 2, motion: motion({ bobPhase: 0.7, spinPhase: 0.15 }) },
  { sprite: CARTRIDGE, depth: 6, fx: 0.9, fy: 0.24, cell: 2, motion: motion({ bobPhase: 0.15, spinPhase: 0.8 }) },
  { sprite: INVADER, depth: 4, fx: 0.58, fy: 0.16, cell: 2, motion: motion({ bobAmplitude: 4, bobPhase: 0.4, spinPhase: 0.45 }) },
  { sprite: GHOST, depth: 7, fx: 0.78, fy: 0.42, cell: 2, motion: motion({ bobAmplitude: 4, bobPhase: 0.85, spinPhase: 0.65 }) },
  { sprite: ROBOT, depth: 6, fx: 0.19, fy: 0.78, cell: 2, motion: motion({ bobPhase: 0.6, spinPhase: 0.25 }) },
  { sprite: COIN, depth: 2, fx: 0.48, fy: 0.45, cell: 3, motion: motion({ bobPhase: 0.2, spinCycle: 6, spinDuration: 2, spinPhase: 0.0 }) },
  { sprite: HEART, depth: 4, fx: 0.9, fy: 0.54, cell: 3, motion: motion({ bobAmplitude: 4, bobPhase: 0.35, spinCycle: 20, spinPhase: 0.9 }) },
  { sprite: STAR, depth: 3, fx: 0.36, fy: 0.56, cell: 3, motion: motion({ bobPhase: 0.55, spinCycle: 9, spinPhase: 0.4 }) },
  { sprite: STAR, depth: 3, fx: 0.66, fy: 0.6, cell: 2, motion: motion({ bobPhase: 0.1, spinCycle: 11, spinPhase: 0.7 }) },
  { sprite: STAR, depth: 3, fx: 0.24, fy: 0.32, cell: 2, motion: motion({ bobAmplitude: 2, bobPhase: 0.9, spinCycle: 13, spinPhase: 0.2 }) },
];
